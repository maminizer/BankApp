...
const COLOR_DARK = Color.fromRGBO(9, 24, 47, 1.0);
const COLOR_GREY_LIGHT = Color(0xFFE0E0E0);
const COLOR_WHITE = Colors.white;
const COLOR_DARK_BLUE = Color.fromRGBO(20, 25, 45, 1.0);

const TextTheme TEXT_THEME_DEFAULT = TextTheme(
    headline1: TextStyle(
        color: COLOR_DARK, fontWeight: FontWeight.w700, fontSize: 24),
    headline2: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w600, fontSize: 22),
    headline3: TextStyle(
        color: COLOR_DARK, fontWeight: FontWeight.w600, fontSize: 22),
    headline4: TextStyle(
        color: COLOR_DARK, fontWeight: FontWeight.w700, fontSize: 14),
    headline5: TextStyle(
        color: COLOR_GREY, fontWeight: FontWeight.w600, fontSize: 16),
    headline6: TextStyle(
